      ...
      <div className="container-lg">
        ...
        <section>
          <div>
            ...
            <p className="heading fw-light fs-1">Chief Humans at Humanhood</p>
            ...
            <div className="row">
              <div class="card col-md-6 rounded-0 m-0 p-1 border-0">
                ...
                <div class="card-body m-0">
                  <p class="card-text p-0 m-0">Sakshi Sanghavi - Founder</p>
                </div>
              </div>
              <div class="card col-md-6 rounded-0 border-0 m-0 p-1">
                ...
                />
                <div class="card-body  m-0">
                  <p class="card-text p-0 m-0">Unnati Shah - Founderer</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <p className="text text-center px-lg-5">
        ...
        <section>
          ...
          <p className="heading fw-light fs-1">Thoughts Become Things</p>
